...
Find the least common multiple of $15, 20, 25$ by turning the numbers into their prime factorization. $$15 = 3 \cdot 5, 20 = 2^2 \cdot 5, 25 = 5^2$$ Gather all necessary multiples 
...
*Note - If you don't know the diagonal formula, you can also find the length of the square using the Pythagorean Theorem (set up an equation and solve for $x$), which is $\sqrt{2}$, and get that the area is $2$, and continute as shown in the solution.
