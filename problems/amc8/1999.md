...
If the time is $10:00$, then the hour hand will be on $10$, and the minute hand will be on, $12$, making them $2$ numbers apart, so they will be $60$ degrees apart, or $\boxed{\textbf{(C) } 60}$
...
twice, so the total is $500 + 450 + 350 - 50 - 100 = \boxed{\text{(C)}\ 1150}$.
...
===Solution 1===
$$\frac{\text{time not green}}{\text{total time}}
=
\frac{R + Y}{R + Y + G}
=
\frac{35}{60}
=
\boxed{\text{(E)}\ \frac{7}{12}}$$
...
=
\frac{5}{12}$, 
so the probability of not green is $1-  \frac{5}{12} =
\boxed{\text{(E)}\ \frac{7}{12}}$
.
...
$13$, the sum is the largest, $$[10 + 4 + 1 + 7 + 2(13)]=2S\\ 48=2S\\ S=\boxed{\text{(D)}\ 24}$$
The other
...
**Solution 2 (Quick and Easy, using larger triangles).**
...
Let $f$ represent one fish, $l$ a loaf of bread, and $r$ a bag of rice. Then:
$3f=2l$, 
$l=4r$
...
## Problem 24
*Tags: binomial-theorem, fermats-little-theorem, modular-arithmetic*
...
## Problem 25
*Tags: congruent-triangles, geometric-series*
