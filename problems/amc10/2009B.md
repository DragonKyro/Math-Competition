...
Next, we multiply both the numerator and denominator by $12$. $\dfrac{\frac{1}{3}-\frac{1}{4}}{\frac{1}{2}-\frac{1}{3}}=\dfrac{\frac{4}{12}-\frac{3}{12}}{\frac{6}{12}-\frac{4}{12}}=\dfrac{\frac{1}{12}}{\frac{2}{12}}=\boxed{(C)\dfrac{1}{2}}$.
-sosiaops
...
## Problem 18
*Tags: coordinate-bash, pythagorean-theorem, shoelace-theorem*
...
## Problem 20
*Tags: angle-bisector-theorem, congruent-triangles, double-angle-identities, pythagorean-theorem*
...
$$BD(\sqrt5+1)=2$$
$$BD=\frac{2}{\sqrt5+1}=\boxed{\frac{\sqrt5-1}{2}} \implies {B}$$
...
Make $DE$ a line so that it is perpendicular to $AC$. Since $AD$ is an angle bisector, $\triangle AED$ is congruent to $\triangle ABD$.
